namespace Yfy.Api.Items
{
    ...
    public class ItemRouter
    {
        ...
        public YfyItemCollection Search(string queryWords, long searchInFolder = 0, ItemType type = ItemType.all, int pageNumber = 0)
        {
            return this._transport.SendRpcRequest<GetArg, YfyItemCollection>(new GetArg(), UriHelper.SearchUri(queryWords, searchInFolder, type, pageNumber));
        }
    }
}
